...
public:
    ...
    static std::string handle_login_command(std::vector<std::string> lineParts, User *currentUser);
    static std::string handle_logout_command(std::vector<std::string> lineParts, User *currentUser, int receiptId);
    static std::string handle_join_command(std::vector<std::string> lineParts, User *currentUser, int subscriptionId);
